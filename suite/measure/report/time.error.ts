import type {TimeRunnerMessage} from '../model/time.ts'
...
export function reportError(logger: Logger, algorithm: Algorithm, timestamp: string, snapshotFilePath: string, message: TimeRunnerMessage): void {
